...
if st.session_state.current_page == "home":
    ...
    .home-icon1{ background:#eaf4ff; }
    .home-icon2{ background:#fff2e8; }
    .home-icon3{ background:#eef9ef; }
    .home-icon4{ background:#f3ebff; }
    ...
    with col1:
        st.markdown(dedent("""
        <div class="home-card">
            <div class="home-icon-box home-icon1">📊</div>
        ...
        if st.button("📊 Анализ нээх", use_container_width=True, key="analysis_btn"):
            st.markdown(dedent("""
    ...
    with col2:
        st.markdown(dedent("""
        <div class="home-card">
            <div class="home-icon-box home-icon2">📝</div>
        ...
        if st.button("📝 Тест засах", use_container_width=True, key="test_btn"):
            st.markdown(dedent("""
    ...
    with col3:
        st.markdown(dedent("""
        <div class="home-card">
            <div class="home-icon-box home-icon3">📚</div>
        ...
        if st.button("📚 Төлөвлөгөө нээх", use_container_width=True, key="lesson_btn"):
            st.markdown(dedent("""
    ...
    with col4:
        st.markdown(dedent("""
        <div class="home-card">
            <div class="home-icon-box home-icon4">🤖</div>
        ...
        if st.button("🤖 Teacher AI OMR нээх", use_container_width=True, key="teacher_ai_btn"):
            st.markdown(dedent("""
